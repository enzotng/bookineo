        ...
        <div className="p-4 border-b bg-white space-y-4">
            <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                    ...
                    {hasActiveFilters && (
                        <Button variant="ghost" size="sm" onClick={clearFilters} className="text-xs text-gray-500 hover:text-gray-700">
                ...
                {unreadCount > 0 && (
                    <Button variant="outline" size="sm" onClick={onMarkAllAsRead} className="flex items-center space-x-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <Select value={filters.unreadOnly ? "unread" : "all"} onValueChange={(value) => handleFilterChange("unreadOnly", value === "unread")}>
