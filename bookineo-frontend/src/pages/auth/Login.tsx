            ...
            <Card className="bg-baby-powder-900/95 backdrop-blur-lg border-0 shadow-2xl w-full max-w-md mx-auto relative z-[100]">
                ...
                <CardContent>
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        {error && <div className="bg-bistre-900/50 border border-bistre-600 text-bistre-600 px-4 py-3 rounded-md text-sm">{error}</div>}
                        ...
                        <div className="space-y-2">
                            ...
                            <Link to="/auth/forgot-password" className="text-xs text-blue-600 hover:underline font-medium">
                                Mot de passe oublié ?
                            </Link>
